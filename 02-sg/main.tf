...
resource "aws_security_group_rule" "vpn_home" {
  security_group_id = module.vpn.sg_id  # sg_id is output name
  type              = "ingress"
  from_port         = 0
  to_port           = 65535
  protocol          = "-1"
...
resource "aws_security_group_rule" "mongodb_vpn" {
  source_security_group_id = module.vpn.sg_id  # sg_id is output name
  type              = "ingress"
  from_port         = 22
  to_port           = 22
  protocol          = "tcp"
...
resource "aws_security_group_rule" "mongodb_catalogue" {
  source_security_group_id = module.catalogue.sg_id  # sg_id is output name
  type              = "ingress"
  from_port         = 27017
  to_port           = 27017
  protocol          = "tcp"
...
resource "aws_security_group_rule" "mongodb_user" {
  source_security_group_id = module.user.sg_id  # sg_id is output name
  type              = "ingress"
  from_port         = 27017
  to_port           = 27017
  protocol          = "tcp"
...
resource "aws_security_group_rule" "redis_cart" {
  source_security_group_id = module.cart.sg_id  # sg_id is output name
  type              = "ingress"
  from_port         = 6379
  to_port           = 6379
  protocol          = "tcp"
